...
namespace Symfony\HttpFoundation\Tests\Session;
...
{
    /**
     * @var \Symfony\HttpFoundation\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \Symfony\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    /**
     * @covers Symfony\HttpFoundation\Session\Session::getIterator
     */
    ...
    /**
     * @covers \Symfony\HttpFoundation\Session\Session::count
     */
    ...
    {
        $this->assertInstanceOf('Symfony\HttpFoundation\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }
}
