...
namespace Symfony\HttpFoundation\Tests\Session\Storage;

use Symfony\HttpFoundation\Session\Storage\Handler\NativeSessionHandler;
use Symfony\HttpFoundation\Session\Storage\NativeSessionStorage;
use Symfony\HttpFoundation\Session\Flash\FlashBag;
use Symfony\HttpFoundation\Session\Attribute\AttributeBag;
use Symfony\HttpFoundation\Session\Storage\Proxy\NativeProxy;
use Symfony\HttpFoundation\Session\Storage\Proxy\SessionHandlerProxy;
...
class NativeSessionStorageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetSaveHandler53()
    {
        ...
        $this->assertInstanceOf('Symfony\HttpFoundation\Session\Storage\Proxy\NativeProxy', $storage->getSaveHandler());
        $storage->setSaveHandler(null);
        $this->assertInstanceOf('Symfony\HttpFoundation\Session\Storage\Proxy\NativeProxy', $storage->getSaveHandler());
        $storage->setSaveHandler(new NativeSessionHandler());
        $this->assertInstanceOf('Symfony\HttpFoundation\Session\Storage\Proxy\NativeProxy', $storage->getSaveHandler());
        $storage->setSaveHandler(new SessionHandlerProxy(new SessionHandler()));
        $this->assertInstanceOf('Symfony\HttpFoundation\Session\Storage\Proxy\SessionHandlerProxy', $storage->getSaveHandler());
