...
namespace Symfony\HttpFoundation\Tests\File;
...
class FileTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMove()
    {
        ...
        $this->assertInstanceOf('Symfony\HttpFoundation\File\File', $movedFile);
    ...
    {
        $guesser = $this->getMock('Symfony\HttpFoundation\File\MimeType\MimeTypeGuesserInterface');
        $guesser
            ->expects($this->once())
            ->method('guess')
