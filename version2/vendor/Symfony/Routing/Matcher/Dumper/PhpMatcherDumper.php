...
namespace Symfony\Routing\Matcher\Dumper;

use Symfony\Routing\Route;
use Symfony\Routing\RouteCollection;
use Symfony\ExpressionLanguage\ExpressionLanguage;
...
class PhpMatcherDumper extends MatcherDumper
{
    ...
    public function dump(array $options = array())
    {
        $options = array_replace(array(
            ...
            'base_class' => 'Symfony\\Routing\\Matcher\\UrlMatcher',
        ), $options);

        // trailing slash support is only enabled if we know how to redirect the user
        $interfaces = class_implements($options['base_class']);
        $supportsRedirections = isset($interfaces['Symfony\\Routing\\Matcher\\RedirectableUrlMatcherInterface']);
...
EOF;
    ...
    private function getExpressionLanguage()
    {
        if (null === $this->expressionLanguage) {
            if (!class_exists('Symfony\ExpressionLanguage\ExpressionLanguage')) {
