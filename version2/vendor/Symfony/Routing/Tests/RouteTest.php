...
class RouteTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOptions()
    {
        ...
        'compiler_class'     => 'Symfony\\Routing\\RouteCompiler',
        ...
        $this->assertEquals(array('foo' => 'foo', 'bar' => 'bar', 'compiler_class' => 'Symfony\\Routing\\RouteCompiler'), $route->getOptions(), '->addDefaults() keep previous defaults');
    }
    ...
    {
        $route = new Route('/{foo}');
        $this->assertInstanceOf('Symfony\Routing\CompiledRoute', $compiled = $route->compile(), '->compile() returns a compiled route');
