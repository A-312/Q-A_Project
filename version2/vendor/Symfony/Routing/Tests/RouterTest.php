...
namespace Symfony\Routing\Tests;
...
class RouterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->loader = $this->getMock('Symfony\Config\Loader\LoaderInterface');
    ...
    public function testThatRouteCollectionIsLoaded()
    {
        ...
        $routeCollection = $this->getMock('Symfony\Routing\RouteCollection');
    ...
    public function testMatcherIsCreatedIfCacheIsNotConfigured($option)
    {
        ...
        $this->loader->expects($this->once())
            ...
            ->will($this->returnValue($this->getMock('Symfony\Routing\RouteCollection')));

        $this->assertInstanceOf('Symfony\\Routing\\Matcher\\UrlMatcher', $this->router->getMatcher());
    ...
    public function testGeneratorIsCreatedIfCacheIsNotConfigured($option)
    {
        ...
        $this->assertInstanceOf('Symfony\\Routing\\Generator\\UrlGenerator', $this->router->getGenerator());
    ...
    {
        $matcher = $this->getMock('Symfony\Routing\Matcher\UrlMatcherInterface');
    ...
    {
        $matcher = $this->getMock('Symfony\Routing\Matcher\RequestMatcherInterface');
