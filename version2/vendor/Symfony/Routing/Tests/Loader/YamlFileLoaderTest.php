...
use Symfony\Routing\Loader\YamlFileLoader;
...
class YamlFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $loader = new YamlFileLoader($this->getMock('Symfony\Config\FileLocator'));
    ...
    public function testLoadSpecialRouteName()
    {
        ...
        $this->assertInstanceOf('Symfony\Routing\Route', $route);
