...
namespace Symfony\Routing\Generator;

use Symfony\Routing\RouteCollection;
use Symfony\Routing\RequestContext;
use Symfony\Routing\Exception\InvalidParameterException;
use Symfony\Routing\Exception\RouteNotFoundException;
use Symfony\Routing\Exception\MissingMandatoryParametersException;
...
class UrlGenerator implements UrlGeneratorInterface, ConfigurableRequirementsInterface
{
    ...
    protected function doGenerate($variables, $defaults, $requirements, $tokens, $parameters, $name, $referenceType, $hostTokens)
    {
        ...
        // the contexts base URL is already encoded (see Symfony\HttpFoundation\Request)
